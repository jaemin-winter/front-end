...
const useArticleComposable = () => {
    ...
    return { getArticleList, createArticle, getArticleDetail, deleteArticle, getCommentList, createComment, deleteComment, updateArticle, createReply, articleLikes, commentLikes ,deleteReply}
}
